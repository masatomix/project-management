 ...
 * @version $Revision$
 */
public class AbstractExecutorRunnableWithProgress implements
        IRunnableWithProgress {
    /**
     * Logger for this class
     */
    private static final Logger logger = Logger
            .getLogger(AbstractExecutorRunnableWithProgress.class);
    ...
    public AbstractExecutorRunnableWithProgress(IStructuredSelection ss,
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException,
        ...
        while (e.hasNext()) {
            ...
            //                    if (id.equals("nu.mine.kino.plugin.beangenerator.actions.JavaBeansReaderGeneratorAction")) { //$NON-NLS-1$

 ...
 */
public class NewExtensionLocationActionDelegate implements
     ...
     * The constructor.
     */
    public NewExtensionLocationActionDelegate() {
    }
    ...
    public void run(IAction action) {
        ...
        NewExtensionLocationAction newExtensionLocationAction = new NewExtensionLocationAction(
                shell, UpdateUIMessages.ConfigurationView_extLocation,
                UpdateUIImages.DESC_ESITE_OBJ);
        newExtensionLocationAction.run();
    }

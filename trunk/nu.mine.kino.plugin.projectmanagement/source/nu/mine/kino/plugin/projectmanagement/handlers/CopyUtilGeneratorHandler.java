...
import nu.mine.kino.plugin.projectmanagement.actions.CopyUtilCreatorWithProgress;
 ...
 * @version $Revision$
 */
public class CopyUtilGeneratorHandler extends AbstractHandler {
    /**
     * Logger for this class
     */
    private static final Logger logger = Logger
            .getLogger(CopyUtilGeneratorHandler.class);
        ...
        try {
            ...
            if (!MessageDialog
                    .openConfirm(
                            ...
                            name
                                    + Messages.CopyUtilGeneratorHandler_MSG_DIALOG_DESC)) {
                return null;
            }
            ...
            try {
                ...
                CopyUtilCreatorWithProgress progress = new CopyUtilCreatorWithProgress(
                        ss, site, id);
